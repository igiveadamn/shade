...
class OccupanciesControllerTest < ActionController::TestCase
  ...
  def test_should_create_occupancy
    assert_difference('Occupancy.count') do
      post :create, :occupancy => { :quantity => 1, :comments => "Comments", :men => 12, :women => 23, :children => 34, :babies => 45, :working => 45, :school => 45, :pregnant => 45, :chronic_medication => 56 }, :location_id => locations(:rosebank).id
    end
