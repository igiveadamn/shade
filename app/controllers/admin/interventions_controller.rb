  ...
  def create
    ...
    respond_to do |format|
      if @intervention.save
        flash[:notice] = 'Admin::Intervention was successfully created.'
        format.html { redirect_to admin_interventions_path }
  ...
  def update
    ...
    respond_to do |format|
      if @intervention.update_attributes(params[:intervention])
        flash[:notice] = 'Admin::Intervention was successfully updated.'
        format.html { redirect_to admin_interventions_path }
        format.xml  { head :ok }
      else
